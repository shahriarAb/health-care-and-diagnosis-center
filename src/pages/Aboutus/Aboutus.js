    ...
    return (
        <div>
            <div className="mx-16">
                ...
                <div className="lg:flex">
                    ...
                    <div className="mt-4 ml-8">
                        ...
                        <p className="text-lg ml-4"><i>"We have 20 years of successfull experience. We always try to give the best service from the beginning</i></p>
                    </div>
                </div>
                <div className="lg:flex ml-10 mt-2">
                    ...
                    <div className="mt-4 ml-8">
                        ...
                        <p className="text-lg ml-4"><i>"We give you the experienced and well trained Doctors. Doctors are very helpfull and always try to motivate patient.</i></p>
                    </div>
                </div>
                <div className="lg:flex ml-20 mt-2">
                    ...
                    <div className="mt-4 ml-8">
                        ...
                        <p className="text-lg ml-4"><i>"From the beginning we improves our services day by day. You are always welcome to give your all important opinion and elp us to improve more. Feel always free to let us know. Go to feedback hub on <Link to="/home"></Link> and give your counsel.</i></p>
                    </div>
                </div>
                <div className="lg:flex ml-32">
                    ...
                    <div className="mt-4 ml-8">
                        ...
                        <p className="text-lg ml-4"><i>"We always try to give you the best diagnosis/test results. We have world class machines and lab experts which are very helpfull to give you best result always.</i></p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8 mx-8">
                <div className="lg:flex">
                    <div className="text-6xl text-indigo-500 service-icon"><i className="fas fa-stethoscope"></i></div>
                    <div className="ml-6">
                ...
                <div className="lg:flex">
                    <div className="text-6xl text-indigo-500 service-icon"><i class="fas fa-ambulance"></i></div>
                    <div className="ml-6">
                ...
                <div className="lg:flex">
                    <div className="text-6xl text-indigo-500 service-icon"><i class="far fa-credit-card"></i></div>
                    <div className="ml-6">
                ...
                <div className="lg:flex">
                    <div className="text-6xl text-indigo-500 service-icon"><i class="fas fa-map-marker"></i></div>
                    <div className="ml-6">
                ...
                <div className="lg:flex">
                    <div className="text-6xl text-indigo-500 service-icon"><i class="fas fa-pills"></i></div>
                    <div className="ml-6">
                ...
                <div className="lg:flex">
                    <div className="text-6xl text-indigo-500 service-icon"><i class="fas fa-phone-square"></i></div>
                    <div className="ml-6">
