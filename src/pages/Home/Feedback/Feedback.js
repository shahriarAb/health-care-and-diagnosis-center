...
const Feedback = () => {
    return (
        <div>
            ...
            <div className="text-center mt-6 mx-8 p-6 border-2 bg-gradient-to-r from-blue-300 to-blue-100 border-blue-400 rounded-lg">
                ...
                <textarea
                    className="mt-12 focus:outline-none focus:ring-2 focus:ring-blue-800 focus:border-transparent border-2 shadow-inner shadow-mg rounded-md lg:w-1/2 sm:w-2/3 p-2"
